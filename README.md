...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/demospotlight)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/demospotlight
```

A live public deployment of this template is available at [https://demospotlight.templates.workers.dev](https://demospotlight.templates.workers.dev)
